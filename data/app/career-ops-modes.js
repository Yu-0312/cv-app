window.CV_CAREER_OPS_MODES = {
  "name": "CV Studio Career Ops Modes",
  "description": "Slash-command style mode registry that mirrors career-ops command ergonomics while staying compatible with the web app and backend scripts.",
  "commands": [
    {
      ...
      "outputs": [
        ...
        "data/app/career-ops-parallel-report.md"
      ]
    },
    {
      "command": "/career-ops source-flex",
    ...
    },
    {
      ...
      "outputs": [
        "data/app/career-ops-deep-research.md",
        "data/app/career-ops-deep-fit.md"
      ]
    },
    {
      "command": "/career-ops comp",
      "script": "npm run career-ops:compensation",
      "purpose": "Create compensation structures and negotiation scripts.",
      "outputs": [
        "data/app/career-ops-compensation.md"
      ]
    },
    {
      ...
      "outputs": [
        "data/app/career-ops-story-bank.md"
      ]
    },
    {
      ...
      "outputs": [
        "data/app/career-ops-apply-agent-report.md"
      ]
    },
    {
      "command": "/career-ops learn",
      "script": "npm run career-ops:learn",
      "purpose": "Learn preferences from scores, statuses, feedback, and source metadata.",
      "outputs": [
        "data/app/career-ops-learning-report.md"
      ]
    },
    {
      "command": "/career-ops doctor",
  ...
  "generatedAt": "2026-05-15T23:22:33.801Z"
};
