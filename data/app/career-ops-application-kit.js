  ...
  "playbooks": [
    ...
    },
    {
      ...
      "applyChecklist": [
        ...
        "Do not overclaim missing areas: JavaScript, React, CSS, Accessibility, API, dashboard",
        "Log status, recruiter/contact, and next follow-up date in the tracker."
      ],
      "outreachEmail": {
    ...
    },
    {
      ...
      "applyChecklist": [
        ...
        "Do not overclaim missing areas: CSS, Accessibility, API, remote, dashboard, design system",
        "Log status, recruiter/contact, and next follow-up date in the tracker."
      ],
      "outreachEmail": {
