...
Generated: 2026-05-22T01:56:10.974Z
Stories: 8
...
- [P0] go (市場出現 32 次) — 高優先：在簡歷或 profile 中加入 go 的實際使用案例，並在 projects 欄位補充相關實作。
...
- [P0] sql (市場出現 17 次) — 高優先：在簡歷或 profile 中加入 sql 的實際使用案例，並在 projects 欄位補充相關實作。
