...
const DEFAULT_OUT = "tooling/data/app/career-ops-story-bank.json";
const DEFAULT_JS_OUT = "tooling/data/app/career-ops-story-bank.js";
const DEFAULT_REPORT = "tooling/data/app/career-ops-story-bank.md";
