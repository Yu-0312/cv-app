...
const DEFAULT_OUT = "tooling/data/app/career-ops-learning.json";
const DEFAULT_JS_OUT = "tooling/data/app/career-ops-learning.js";
const DEFAULT_REPORT = "tooling/data/app/career-ops-learning-report.md";
