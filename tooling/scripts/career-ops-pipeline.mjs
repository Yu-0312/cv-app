...
const DEFAULT_PROFILE = fs.existsSync("tooling/data/career-ops-profile.json")
  ? "tooling/data/career-ops-profile.json"
  : "tooling/data/career-ops-profile.example.json";
const DEFAULT_RUBRIC = fs.existsSync("tooling/data/career-ops-rubric.json")
...
function parseArgs(argv) {
  const args = {
    ...
    strategy: fs.existsSync("tooling/data/career-ops-source-strategy.json") ? "tooling/data/career-ops-source-strategy.json" : "",
...
function main() {
  ...
  if (!args.skipHealth && fs.existsSync("tooling/data/app/career-ops-jobs.json")) {
    run("job health monitor", "node", [
      "scripts/career-ops-health-monitor.mjs",
      "--jobs", "tooling/data/app/career-ops-jobs.json",
      "--out", "tooling/data/app/career-ops-job-health.json",
      "--report-out", "tooling/data/app/career-ops-job-health-report.md",
  ...
  if (args.strategy && fs.existsSync(args.strategy)) {
    run("source-strategy agent", "node", [
      ...
      "--out", "tooling/data/career-ops-sources.json",
      "--report-out", "tooling/data/app/career-ops-source-strategy-report.md",
      ...marketArgs(args.markets)
    ]);
  }

  if (!args.skipSourceFlex && fs.existsSync("tooling/data/career-ops-source-flex.json")) {
  ...
  for (const filePath of args.searchResults) {
    run("search adapter agent", "node", [
      ...
      "--strategy", args.strategy || "tooling/data/career-ops-source-strategy.json",
      "--results", filePath,
      "--append", "tooling/data/career-ops-sources.json",
      "--out", "tooling/data/career-ops-sources.json",
      "--report-out", "tooling/data/app/career-ops-search-report.md"
    ]);
  }
  ...
  if (!args.skipScrape) {
    run("source scanner agent", "node", [
      ...
      "--source", "tooling/data/career-ops-sources.json",
      "--json-out", "tooling/data/app/career-ops-jobs.json",
  ...
  if (!args.skipCompensation) {
    run("compensation agent", "node", [
      ...
      "--out", "tooling/data/app/career-ops-compensation.json",
      "--js-out", "tooling/data/app/career-ops-compensation.js",
      "--report-out", "tooling/data/app/career-ops-compensation.md"
    ]);
  }
  ...
  if (!args.skipStoryBank) {
    run("story bank agent", "node", [
      ...
      "--jobs", "tooling/data/app/career-ops-jobs.json",
      "--profile", args.profile,
      "--out", "tooling/data/app/career-ops-story-bank.json",
      "--js-out", "tooling/data/app/career-ops-story-bank.js",
      "--report-out", "tooling/data/app/career-ops-story-bank.md"
    ]);
  }
