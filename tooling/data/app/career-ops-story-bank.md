...
Generated: 2026-07-06T15:53:57.171Z
Stories: 8
...
- [P0] llm (市場出現 16 次) — 高優先：在簡歷或 profile 中加入 llm 的實際使用案例，並在 projects 欄位補充相關實作。
- [P0] kubernetes (市場出現 15 次) — 高優先：在簡歷或 profile 中加入 kubernetes 的實際使用案例，並在 projects 欄位補充相關實作。
