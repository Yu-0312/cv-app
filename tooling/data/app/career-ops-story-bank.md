...
Generated: 2026-06-21T00:04:46.840Z
Stories: 8
...
- [P0] growth (市場出現 58 次) — 高優先：在簡歷或 profile 中加入 growth 的實際使用案例，並在 projects 欄位補充相關實作。
...
- [P0] python (市場出現 25 次) — 高優先：在簡歷或 profile 中加入 python 的實際使用案例，並在 projects 欄位補充相關實作。
