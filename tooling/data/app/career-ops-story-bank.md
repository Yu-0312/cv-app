...
Generated: 2026-06-22T00:17:01.050Z
Stories: 8
...
- [P0] sales (市場出現 32 次) — 高優先：在簡歷或 profile 中加入 sales 的實際使用案例，並在 projects 欄位補充相關實作。
...
- [P0] rest (市場出現 19 次) — 高優先：在簡歷或 profile 中加入 rest 的實際使用案例，並在 projects 欄位補充相關實作。
