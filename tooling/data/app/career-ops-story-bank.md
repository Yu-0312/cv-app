...
Generated: 2026-06-29T00:01:13.366Z
Stories: 8
...
- [P0] rest (市場出現 22 次) — 高優先：在簡歷或 profile 中加入 rest 的實際使用案例，並在 projects 欄位補充相關實作。
- [P0] java (市場出現 21 次) — 高優先：在簡歷或 profile 中加入 java 的實際使用案例，並在 projects 欄位補充相關實作。
- [P0] sales (市場出現 20 次) — 高優先：在簡歷或 profile 中加入 sales 的實際使用案例，並在 projects 欄位補充相關實作。
- [P0] azure (市場出現 19 次) — 高優先：在簡歷或 profile 中加入 azure 的實際使用案例，並在 projects 欄位補充相關實作。
