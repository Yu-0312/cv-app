...
Generated: 2026-06-25T00:06:56.416Z
Stories: 8
...
- [P0] python (市場出現 31 次) — 高優先：在簡歷或 profile 中加入 python 的實際使用案例，並在 projects 欄位補充相關實作。
...
- [P0] go (市場出現 18 次) — 高優先：在簡歷或 profile 中加入 go 的實際使用案例，並在 projects 欄位補充相關實作。
