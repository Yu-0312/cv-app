  ...
  "results": [
    ...
    },
    {
      ...
      "workers": {
        ...
        "applyAgent": {
          "mode": "human-in-the-loop",
          "url": "https://www.mycareersfuture.gov.sg/job/820f670accd3b1a25b791a4f3507dcf4",
          "steps": [
            "Open the application URL in a controlled browser session.",
            "Extract visible form fields and required uploads.",
            "Map CV profile fields to the form without submitting.",
    ...
    },
    {
      ...
      "workers": {
        ...
        "compensation": {
          ...
          "negotiationScript": {
            "recruiterRangeQuestion": "Before I anchor on a number, could you share the approved range and level for the Principal/Staff ML/AI Engineer, Product Engineering, STPG package, including base, bonus, equity, and review cycle?",
        ...
        "applyAgent": {
          "mode": "human-in-the-loop",
          "url": "https://www.mycareersfuture.gov.sg/job/512655692191f59f04fe50cd196b2ba0",
          "steps": [
            "Open the application URL in a controlled browser session.",
            "Extract visible form fields and required uploads.",
            "Map CV profile fields to the form without submitting.",
    ...
    },
    {
      ...
      "workers": {
        ...
        "applyAgent": {
          "mode": "human-in-the-loop",
          "url": "https://www.themuse.com/jobs/uber/data-engineer-2-0c04ca",
          "steps": [
            "Open the application URL in a controlled browser session.",
            "Extract visible form fields and required uploads.",
            "Map CV profile fields to the form without submitting.",
