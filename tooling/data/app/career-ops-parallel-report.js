window.CV_CAREER_OPS_PARALLEL = {
  ...
  "generatedAt": "2026-05-26T00:04:57.737Z",
  "concurrency": 4,
  "jobCount": 50,
  "results": [
    {
      ...
      "grade": "A",
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.687Z",
      "completedAt": "2026-05-26T00:04:57.688Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
    ...
    },
    {
      ...
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.687Z",
      "completedAt": "2026-05-26T00:04:57.689Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
        ...
        "compensation": {
          ...
          "negotiationScript": {
            "recruiterRangeQuestion": "Before I anchor on a number, could you share the approved range and level for the AVP, Frontend Engineer, Technology Group(17140) package, including base, bonus, equity, and review cycle?",
    ...
    },
    {
      ...
      "grade": "A",
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.686Z",
      "completedAt": "2026-05-26T00:04:57.687Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
        ...
        "applyAgent": {
          "mode": "human-in-the-loop",
          "url": "https://www.mycareersfuture.gov.sg/job/8d78864dfd9812b42055dfb7ddd5058e",
          "steps": [
            "Open the application URL in a controlled browser session.",
            "Extract visible form fields and required uploads.",
            "Map CV profile fields to the form without submitting.",
    ...
    },
    {
      ...
      "grade": "A",
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.689Z",
      "completedAt": "2026-05-26T00:04:57.690Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
        ...
        "applyAgent": {
          "mode": "human-in-the-loop",
          "url": "https://www.mycareersfuture.gov.sg/job/d90a32999a849424269dfae3f20b3460",
          "steps": [
            "Open the application URL in a controlled browser session.",
            "Extract visible form fields and required uploads.",
            "Map CV profile fields to the form without submitting.",
    ...
    },
    {
      ...
      "grade": "A",
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.691Z",
      "completedAt": "2026-05-26T00:04:57.691Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
        ...
        "compensation": {
          ...
          "negotiationScript": {
            "recruiterRangeQuestion": "Before I anchor on a number, could you share the approved range and level for the Lead Software Engineer package, including base, bonus, equity, and review cycle?",
    ...
    },
    {
      ...
      "workers": {
        ...
        "compensation": {
          ...
          "negotiationScript": {
            "recruiterRangeQuestion": "Before I anchor on a number, could you share the approved range and level for the Principal Engineer - GBS IND package, including base, bonus, equity, and review cycle?",
    ...
    },
    {
      ...
      "grade": "A",
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.692Z",
      "completedAt": "2026-05-26T00:04:57.694Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
        ...
        "applyAgent": {
          "mode": "human-in-the-loop",
          "url": "https://www.themuse.com/jobs/uber/software-engineer-ii-frontend-3e411c",
          "steps": [
            "Open the application URL in a controlled browser session.",
            "Extract visible form fields and required uploads.",
            "Map CV profile fields to the form without submitting.",
    ...
    },
    {
      ...
      "grade": "A",
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.693Z",
      "completedAt": "2026-05-26T00:04:57.695Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
        ...
        "compensation": {
          ...
          "negotiationScript": {
            "recruiterRangeQuestion": "Before I anchor on a number, could you share the approved range and level for the Senior Product Engineer package, including base, bonus, equity, and review cycle?",
        ...
        "applyAgent": {
          "mode": "human-in-the-loop",
          "url": "https://www.themuse.com/jobs/modernanimalinc/senior-product-engineer",
          "steps": [
            "Open the application URL in a controlled browser session.",
            "Extract visible form fields and required uploads.",
            "Map CV profile fields to the form without submitting.",
    ...
    },
    {
      ...
      "workers": {
        ...
        "applyAgent": {
          "mode": "human-in-the-loop",
          "url": "https://www.themuse.com/jobs/gitlab/senior-backend-engineergo-continuous-delivery",
          "steps": [
            "Open the application URL in a controlled browser session.",
            "Extract visible form fields and required uploads.",
            "Map CV profile fields to the form without submitting.",
    ...
    },
    {
      ...
      "workers": {
        ...
        "compensation": {
          ...
          "negotiationScript": {
            "recruiterRangeQuestion": "Before I anchor on a number, could you share the approved range and level for the Senior Associate Engineer (Java Backend) package, including base, bonus, equity, and review cycle?",
        ...
        "applyAgent": {
          "mode": "human-in-the-loop",
          "url": "https://www.themuse.com/jobs/equinixinc/senior-associate-engineer-java-backend",
          "steps": [
            "Open the application URL in a controlled browser session.",
            "Extract visible form fields and required uploads.",
            "Map CV profile fields to the form without submitting.",
    ...
    },
    {
      ...
      "grade": "A",
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.696Z",
      "completedAt": "2026-05-26T00:04:57.698Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
    ...
    },
    {
      ...
      "workers": {
        ...
        "applyAgent": {
          "mode": "human-in-the-loop",
          "url": "https://www.mycareersfuture.gov.sg/job/7fdbc2ddd10823e30828ded216db87b6",
          "steps": [
            "Open the application URL in a controlled browser session.",
            "Extract visible form fields and required uploads.",
            "Map CV profile fields to the form without submitting.",
    ...
    },
    {
      ...
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.696Z",
      "completedAt": "2026-05-26T00:04:57.697Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
        ...
        "compensation": {
          ...
          "negotiationScript": {
            "recruiterRangeQuestion": "Before I anchor on a number, could you share the approved range and level for the Staff Software Engineer, Frontend package, including base, bonus, equity, and review cycle?",
    ...
    },
    {
      ...
      "grade": "A",
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.705Z",
      "completedAt": "2026-05-26T00:04:57.706Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
    ...
    },
    {
      ...
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.705Z",
      "completedAt": "2026-05-26T00:04:57.707Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
    ...
    },
    {
      ...
      "workers": {
        ...
        "compensation": {
          ...
          "negotiationScript": {
            "recruiterRangeQuestion": "Before I anchor on a number, could you share the approved range and level for the Senior Software Engineer - Ruby on Rails package, including base, bonus, equity, and review cycle?",
        ...
        "applyAgent": {
          "mode": "human-in-the-loop",
          "url": "https://japan-dev.com/jobs/treasure-data/treasure-data-senior-software-engineer---ruby-on-rails-a4dp9q",
          "steps": [
            "Open the application URL in a controlled browser session.",
            "Extract visible form fields and required uploads.",
            "Map CV profile fields to the form without submitting.",
    ...
    },
    {
      ...
      "grade": "A",
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.708Z",
      "completedAt": "2026-05-26T00:04:57.710Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
    ...
    },
    {
      ...
      "workers": {
        ...
        "applyAgent": {
          "mode": "human-in-the-loop",
          "url": "https://www.themuse.com/jobs/uber/data-engineer-ii-96bf95",
          "steps": [
            "Open the application URL in a controlled browser session.",
            "Extract visible form fields and required uploads.",
            "Map CV profile fields to the form without submitting.",
    ...
    },
    {
      ...
      "workers": {
        ...
        "applyAgent": {
          "mode": "human-in-the-loop",
          "url": "https://www.themuse.com/jobs/uber/data-engineer-ii-61805b",
          "steps": [
            "Open the application URL in a controlled browser session.",
            "Extract visible form fields and required uploads.",
            "Map CV profile fields to the form without submitting.",
    ...
    },
    {
      ...
      "grade": "A",
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.712Z",
      "completedAt": "2026-05-26T00:04:57.713Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
    ...
    },
    {
      ...
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.712Z",
      "completedAt": "2026-05-26T00:04:57.714Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
    ...
    },
    {
      ...
      "grade": "A",
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.721Z",
      "completedAt": "2026-05-26T00:04:57.723Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
    ...
    },
    {
      ...
      "grade": "A",
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.724Z",
      "completedAt": "2026-05-26T00:04:57.726Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
    ...
    },
    {
      ...
      "grade": "A",
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.725Z",
      "completedAt": "2026-05-26T00:04:57.726Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
    ...
    },
    {
      ...
      "grade": "A",
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.727Z",
      "completedAt": "2026-05-26T00:04:57.729Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
    ...
    },
    {
      ...
      "grade": "A",
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.730Z",
      "completedAt": "2026-05-26T00:04:57.732Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
    ...
    },
    {
      ...
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.730Z",
      "completedAt": "2026-05-26T00:04:57.731Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
    ...
    },
    {
      ...
      "grade": "A",
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.733Z",
      "completedAt": "2026-05-26T00:04:57.735Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
    ...
    },
    {
      ...
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.733Z",
      "completedAt": "2026-05-26T00:04:57.734Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
    ...
    },
    {
      ...
      "grade": "A",
      "priority": "P0",
      "startedAt": "2026-05-26T00:04:57.736Z",
      "completedAt": "2026-05-26T00:04:57.737Z",
      "workers": {
        "evaluation": {
          "recommendation": "值得投遞",
          "keywords": [
